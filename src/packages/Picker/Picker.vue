<template>
    <div :style="{height: `${itemHeight * 7}px`}" class="component-picker">
        ...
        <v-scroller v-model="positions[i]" v-for="(list, i) in dataSource" :key="i" @scroll-leave="scrollLeave(i, $event)" :is-bind-body="true" :prevent-default="true" :max-holder-time="50" :is-self-moving.sync="isSelfMoving" :body-style="bodyStyle" class="list">
