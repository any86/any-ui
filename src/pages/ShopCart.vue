    ...
    <ScrollView class="page-cart">
            ...
            <ListItem :canRemove="true">
                <div class="flex">
                    ...
                    <div class="info flex-item">
                        <router-link :to="{path: '/home/my'}" tag="h5" class="title">9df78eab33525d08d6e5fb8d29df78eab33525d08d6e5fb8d2</router-link>
        ...
        <ListView class="list">
            <ListItem :hasArrow="true">
                <div class="info">
                    <router-link :to="{path: '/home/my'}" tag="h4" class="title">9df78eab33525d08d6e5fb8d29df78eab33525d08d6e5fb8d2</router-link>
