        ...
        <ListView>
            <ListItem>
                <div class="flex">
                    ...
                    <div class="info flex-item">
                        <h1>9df78eab33525d08d6e5fb8d2</h1>
            ...
            <ListItem>
                <div class="flex">
                    ...
                    <div class="info flex-item">
                        <h1>githubusercontent</h1>
                        <Badge type="warning">none</Badge>
                    </div>                   
                </div>
            </ListItem>
...
export default {
    ...
    components: {ListView, ListItem, Badge}
}
</script>
...
.flex{
    padding: 2*$gutter;
    .img{ width: 1rem;height: 1rem;overflow: hidden; 
