<template>
    <v-scroll-view>
        ...
        <v-carousel v-model="index" :slides-per-view="1.7" :load-prev-next="true" :delay="1000" :is-loop="false" :speed="300" @change="activeIndex=$event.activeIndex">
...
export default {
    ...
    data() {
        ...
        return {
            index: 0,
            activeIndex: 0,
            imageList: longImages.slice(0,5)
        };
    },
