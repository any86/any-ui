<template>
    <v-scroll-view>
        ...
        <v-carousel v-model="index" :slides-per-view="1" :load-prev-next="true" :delay="1000"  :is-loop="true" :speed="300"  @change="activeIndex=$event.activeIndex">
...
export default {
    ...
    data() {
        ...
        const imageList = [longImages[0], longImages[1], longImages[4]];
        return {
            index: 0,
            activeIndex: 0,
            imageList: imageList
